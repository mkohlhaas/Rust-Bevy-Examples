...
impl VertexAttributeValues {
  ...
  pub(crate) fn create_compressed_positions(&self, aabb: Aabb3d) -> Option<VertexAttributeValues> {
  ...
  pub(crate) fn push_from(&mut self, source: &VertexAttributeValues, i: usize) {
    match (self, source) {
      ...
      (VertexAttributeValues::Unorm8x4Bgra(this), VertexAttributeValues::Unorm8x4Bgra(source)) => {
        this.push(source[i]);
      }
