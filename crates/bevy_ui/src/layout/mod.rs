...
pub fn ui_layout_system(
    ...
    fn update_children_recursively(
      ...
      let children_changed = ui_children.is_changed(entity)
        || ui_children
          ...
          .any(|child| added_node_query.contains(child) || fixed_node_changes.contains(&child));
      #[cfg(feature = "ghost_nodes")]
  ...
  fn update_uinode_geometry_recursive(
    ...
    )) = node_update_query.get_mut(entity)
    {
      ...
      let new_scrollbar_size = Vec2::new(layout.scrollbar_size.width, layout.scrollbar_size.height);
      ...
      let max_possible_offset = (content_size - layout_size + node.scrollbar_size).max(Vec2::ZERO);
