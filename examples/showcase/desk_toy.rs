    ...
    .with_children(|commands| {
      ...
      for (x, y, radius) in BIRDS_EYES {
        ...
        commands.spawn((
          ...
          Transform::from_xyz(x, y - 1.0, 1.0).with_scale(Vec2::splat(radius + 2.0).extend(1.0)),
        ));
            ...
            (
              ...
              children![
                ...
                (
                  ...
                  Transform::from_xyz(-pupil_highlight_offset, pupil_highlight_offset, 1.0,)
                    .with_scale(Vec3::new(
...
fn drag(
  ...
  let drag_velocity = (new_translation - bevy_transform.translation.truncate()) / time.delta_secs();
