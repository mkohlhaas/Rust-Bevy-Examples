...
impl From<FilterScenario> for String {
  fn from(value: FilterScenario) -> Self {
    match value {
      ...
      FilterScenario::OptInAllKeepWithoutRequired(true) => "opt_in_all_keep_none_without_required",
      FilterScenario::OptInAllKeepWithoutRequired(false) => "opt_in_all_keep_all_without_required",
    }
    .into()
  }
}
