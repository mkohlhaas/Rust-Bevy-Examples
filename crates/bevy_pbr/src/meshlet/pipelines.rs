...
pub fn init_meshlet_pipelines(
  ...
  let second_instance_cull_bind_group_layout = resource_manager
    ...
    .clone();
  let first_bvh_cull_bind_group_layout = resource_manager.first_bvh_cull_bind_group_layout.clone();
  ...
  commands.insert_resource(MeshletPipelines {
    ...
    visibility_buffer_software_raster_shadow_view: pipeline_cache.queue_compute_pipeline(
      ComputePipelineDescriptor {
        label: Some("meshlet_visibility_buffer_software_raster_shadow_view_pipeline".into()),
    ...
    visibility_buffer_hardware_raster_shadow_view: pipeline_cache.queue_render_pipeline(
      RenderPipelineDescriptor {
        label: Some("meshlet_visibility_buffer_hardware_raster_shadow_view_pipeline".into()),
        layout: vec![visibility_buffer_raster_shadow_view_layout.clone()],
        immediate_size: 4,
        vertex: VertexState {
          shader: visibility_buffer_hardware_raster.clone(),
    ...
    visibility_buffer_hardware_raster_shadow_view_unclipped: pipeline_cache.queue_render_pipeline(
      RenderPipelineDescriptor {
        label: Some(
          "meshlet_visibility_buffer_hardware_raster_shadow_view_unclipped_pipeline".into(),
        ),
...
impl MeshletPipelines {
  pub fn get(
    ...
    Some((
      ...
      pipeline_cache.get_render_pipeline(pipeline.visibility_buffer_hardware_raster_shadow_view)?,
      pipeline_cache
