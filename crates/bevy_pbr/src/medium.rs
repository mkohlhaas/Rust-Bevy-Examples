...
use bevy_render::{
  ...
  render_resource::{
    Extent3d, FilterMode, Sampler, SamplerDescriptor, Texture, TextureDataOrder, TextureDescriptor,
...
impl RenderAsset for GpuScatteringMedium {
  ...
  fn prepare_asset(
    ...
    let mut density: Vec<Vec4> = Vec::with_capacity(2 * source_asset.falloff_resolution as usize);
