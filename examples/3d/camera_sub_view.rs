...
fn resize_viewports(
  ...
  for (mut camera, example_viewport) in viewports.iter_mut() {
    ...
    let (size, position) = match example_viewport {
      ...
      ExampleViewports::PerspectiveControl => (small_wide_size, UVec2::new(small_width * 2, 0)),
      ExampleViewports::OrthographicMain => (large_size, UVec2::new(large_width, small_height)),
      ...
      ExampleViewports::OrthographicControl => (small_wide_size, UVec2::new(small_width * 6, 0)),
    };
