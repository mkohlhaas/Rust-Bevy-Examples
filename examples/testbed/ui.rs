      ...
      grid.with_children(|grid| {
        for hinting in [FontHinting::Enabled, FontHinting::Disabled] {
          ...
          content.with_child((
            ...
            TextFont {
              font: FontSource::families("'Comic Sans', Arial, 'Noto Sans', sans-serif"),
              ..Default::default()
            },
          ));
                    ...
                    children![
                      ...
                      (
                        ...
                        children![(
                          ...
                          BackgroundColor(Color::srgba(0.95, 0.85, 0.2, 0.35)),
                        )]
                      )
                    ],
                  ));
  ...
  pub fn setup(mut commands: Commands) {
    ...
    commands.spawn((
      Node {
        ...
        grid_template_rows: vec![GridTrack::auto(), GridTrack::flex(1.0), GridTrack::px(40.)],
        ..default()
      },
      BackgroundColor(Color::WHITE),
