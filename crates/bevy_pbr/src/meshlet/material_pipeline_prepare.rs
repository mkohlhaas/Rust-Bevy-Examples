use super::{
  instance_manager::InstanceManager, pipelines::MeshletPipelines, resource_manager::ResourceManager,
};
use crate::*;
...
pub fn prepare_material_meshlet_meshes_main_opaque_pass(
  ...
  ) in &mut views
  {
      ...
      .collect::<HashSet<_>>()
    {
      ...
      let Some(material_bind_group_allocator) = material_bind_group_allocators.get(&type_id) else {
        continue;
      };
