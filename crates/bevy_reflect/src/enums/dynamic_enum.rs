...
use crate::{
  enums::{
    enum_debug, enum_hash, enum_partial_cmp, enum_partial_eq, Enum, VariantFieldIter, VariantType,
  },
...
impl Clone for DynamicVariant {
  fn clone(&self) -> Self {
    match self {
      ...
      DynamicVariant::Struct(data) => DynamicVariant::Struct(data.to_dynamic_struct().unwrap()),
    }
  }
}
