...
impl Bounded2d for Capsule2d {
  fn aabb_2d(&self, isometry: impl Into<Isometry2d>) -> Aabb2d {
    ...
    let segment =
      Segment2d::from_direction_and_length(isometry.rotation * Dir2::Y, self.half_length * 2.);
...
mod tests {
  ...
  #[test]
  fn acute_triangle() {
    let acute_triangle = Triangle2d::new(Vec2::new(0.0, 1.0), Vec2::NEG_ONE, Vec2::new(1.0, -1.0));
    let translation = Vec2::new(2.0, 1.0);
    let isometry = Isometry2d::from_translation(translation);
