...
use crate::{
  ...
  query::{
    ...
    QueryCombinationIter, QueryContiguousIter, QueryData, QueryEntityError, QueryFilter, QueryIter,
    QueryManyIter, QueryManyUniqueIter, QueryNotDenseError, QueryParIter, QueryParManyIter,
...
impl<'w, 's, D: QueryData, F: QueryFilter> Query<'w, 's, D, F> {
  ...
  #[inline]
  pub unsafe fn get_unchecked(&self, entity: Entity) -> Result<D::Item<'_, 's>, QueryEntityError> {
    // SAFETY: The caller promises that this will not result in multiple mutable references.
