    ...
    unsafe {
      ...
      if insert_mode == InsertMode::Replace {
        ...
        let new_archetype = match archetype_move_type {
          ...
          | ArchetypeMoveType::NewArchetypeNewTable { new_archetype, .. } => new_archetype.as_ref(),
        };
      ...
      ArchetypeMoveType::NewArchetypeNewTable { new_archetype } => {
        ...
        if let Some(swapped_entity) = move_result.swapped_entity {
          ...
          if archetype.id() == swapped_location.archetype_id {
            ...
            new_archetype.set_entity_table_row(swapped_location.archetype_row, result.table_row);
          } else {
