  ...
  I: SlabItem,
{
  ...
  fn new(
    ...
    let initial_slab_slot_capacity = (settings.min_slab_size.div_ceil(layout.slot_size()) as u32)
  ...
  fn grow_if_necessary(
    ...
    while self.current_slot_capacity < new_size_in_slots {
      let new_slab_slot_capacity = ((self.current_slot_capacity as f64 * settings.growth_factor)
        .ceil() as u32)
