...
use bevy_render::{
  ...
  render_resource::{
    BindGroupEntries, Buffer, BufferBinding, BufferDescriptor, BufferUsages, ComputePassDescriptor,
    PipelineCache, ShaderType, SpecializedComputePipelines,
  },
...
impl Plugin for AutoExposurePlugin {
  fn build(&self, app: &mut App) {
    ...
    app
      .add_plugins(RenderAssetPlugin::<GpuAutoExposureCompensationCurve>::default())
