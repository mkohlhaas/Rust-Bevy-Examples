...
impl AxisSettings {
  ...
  /// and `None` otherwise.
  fn filter(&self, new_raw_value: f32, old_raw_value: Option<f32>) -> Option<FilteredAxisPosition> {
...
mod tests {
  use super::{
    gamepad_connection_system, gamepad_event_processing_system, AxisSettings, AxisSettingsError,
    ButtonAxisSettings, ButtonSettings, ButtonSettingsError, Gamepad, GamepadAxis,
