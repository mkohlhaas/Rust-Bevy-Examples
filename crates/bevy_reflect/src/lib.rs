...
bevy_reflect::tests::Test {
  ...
  fn should_reflect_remote_enum() {
    ...
    let mut patch = DynamicEnum::try_from(MyType(external_crate::TheirType::Tuple(123))).unwrap();
      ...
      let data = r#"
{
    "glam::Quat": (1.0, 2.0, 3.0, 4.0),
      ...
      let mut deserializer = Deserializer::from_str(data).expect("Failed to acquire deserializer");
