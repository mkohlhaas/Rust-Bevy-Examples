    ...
    let expected = r#"#![enable(implicit_some)]
{
  ...
  fn should_serialize_non_self_describing_binary() {
    ...
    let expected: Vec<u8> = vec![
      1, 41, 98, 101, 118, 121, 95, 114, 101, 102, 108, 101, 99, 116, 58, 58, 115, 101, 114, 100,
      101, 58, 58, 115, 101, 114, 58, 58, 116, 101, 115, 116, 115, 58, 58, 77, 121, 83, 116, 114,
      117, 99, 116, 123, 1, 12, 72, 101, 108, 108, 111, 32, 119, 111, 114, 108, 100, 33, 1, 246, 1,
      219, 15, 73, 64, 185, 10, 5, 3, 1, 0, 2, 4, 3, 1, 0, 2, 4, 1, 64, 32, 1, 64, 254, 167, 214,
      185, 7, 12, 84, 117, 112, 108, 101, 32, 83, 116, 114, 117, 99, 116, 0, 1, 123, 2, 164, 112,
      157, 63, 164, 112, 77, 64, 3, 20, 83, 116, 114, 117, 99, 116, 32, 118, 97, 114, 105, 97, 110,
      116, 32, 118, 97, 108, 117, 101, 1, 0, 100, 202, 1,
    ];
  ...
  fn should_serialize_self_describing_binary() {
    ...
    let expected: Vec<u8> = vec![
      129, 217, 41, 98, 101, 118, 121, 95, 114, 101, 102, 108, 101, 99, 116, 58, 58, 115, 101, 114,
      100, 101, 58, 58, 115, 101, 114, 58, 58, 116, 101, 115, 116, 115, 58, 58, 77, 121, 83, 116,
      114, 117, 99, 116, 220, 0, 20, 123, 172, 72, 101, 108, 108, 111, 32, 119, 111, 114, 108, 100,
      33, 145, 123, 146, 202, 64, 73, 15, 219, 205, 5, 57, 149, 254, 255, 0, 1, 2, 149, 254, 255,
      0, 1, 2, 129, 64, 32, 145, 64, 145, 206, 59, 154, 201, 255, 172, 84, 117, 112, 108, 101, 32,
      83, 116, 114, 117, 99, 116, 144, 164, 85, 110, 105, 116, 129, 167, 78, 101, 119, 84, 121,
      112, 101, 123, 129, 165, 84, 117, 112, 108, 101, 146, 202, 63, 157, 112, 164, 202, 64, 77,
      112, 164, 129, 166, 83, 116, 114, 117, 99, 116, 145, 180, 83, 116, 114, 117, 99, 116, 32,
      118, 97, 114, 105, 97, 110, 116, 32, 118, 97, 108, 117, 101, 144, 144, 129, 166, 83, 116,
      114, 117, 99, 116, 144, 129, 165, 84, 117, 112, 108, 101, 144, 146, 100, 145, 101,
    ];
  ...
  fn should_return_error_if_missing_registration() {
    ...
    assert_eq!(
      error,
      ron::Error::Message(
        "type `core::ops::RangeInclusive<f32>` is not registered in the type registry".to_string(),
      )
    );
  }
