...
pub struct RenderMultidrawableBin {
  ...
  pub(crate) entity_to_binned_mesh_instance_index: MainEntityHashMap<RenderBinnedMeshInstanceIndex>,
}
    ...
    RenderMultidrawableBatchSetGpuInstanceRemovalResult {
      ...
      displaced_instance: self
        ...
        .map(|displaced_instance| {
          (
            RenderBinnedMeshInstanceIndex(self.render_binned_mesh_instance_buffer.len() as u32),
            *displaced_instance,
          )
        }),
    }
  ...
  BPI: BinnedPhaseItem,
{
  ...
  fn remove(&mut self, main_entity: MainEntity, bin_key: &BPI::BinKey) {
    ...
    match instance_removal_result.displaced_instance {
      ...
      Some((displaced_instance_index, displaced_instance)) => {
        ...
        let displaced_entity = self
          .binned_mesh_instance_index_to_entity
          .pop()
          .expect("If an entity was displaced, the list of mesh instances must be nonempty");
  ...
  fn remove_bin_if_empty(&mut self, bin_key: &BPI::BinKey, bin_index: RenderBinIndex) {
      ...
      .get(old_bin_metadata.indirect_parameters_offset as usize)
    {
      ...
      self.gpu_buffers.bin_metadata_buffer.values_mut()[displaced_bin_metadata_index as usize]
  ...
  fn render_batchable_meshes<'w>(
    ...
    match self.batch_sets {
      ...
      BinnedRenderPhaseBatchSets::Direct(ref batch_set) => {
        for (batch, (batch_set_key, bin_key)) in batch_set.iter().zip(self.batchable_meshes.keys())
        {
          let binned_phase_item = BPI::new(
            batch_set_key.clone(),
            bin_key.clone(),
  ...
  fn render_unbatchable_meshes<'w>(
    ...
    for (batch_set_key, bin_key) in self.unbatchable_meshes.keys() {
      ...
      for (entity_index, entity) in unbatchable_entities.entities.iter().enumerate() {
            ...
            extra_index: match first_indirect_parameters_index {
              ...
              Some(first_indirect_parameters_index) => {
                let first_indirect_parameters_index_for_entity =
                  u32::from(*first_indirect_parameters_index) + entity_index as u32;
                PhaseItemExtraIndex::IndirectParametersIndex {
        ...
        // Fetch the draw function.
        let Some(draw_function) = draw_functions.get_mut(binned_phase_item.draw_function()) else {
          continue;
        };
  ...
  fn new(gpu_preprocessing: GpuPreprocessingMode) -> Self {
    Self {
      ...
      batch_sets: match gpu_preprocessing {
        GpuPreprocessingMode::Culling => BinnedRenderPhaseBatchSets::MultidrawIndirect(vec![]),
        GpuPreprocessingMode::PreprocessingOnly => BinnedRenderPhaseBatchSets::Direct(vec![]),
...
impl UnbatchableBinnedEntityIndexSet {
  ...
  fn indices_for_entity_index(&self, entity_index: u32) -> Option<UnbatchableBinnedEntityIndices> {
    match self {
        ...
        (
          ...
          (
            ...
            gpu_preprocessing::batch_and_prepare_binned_render_phase::<BPI, GFBD>.run_if(
              resource_exists::<BatchedInstanceBuffers<GFBD::BufferData, GFBD::BufferInputData>>,
            ),
          )
    ...
    match self {
      UnbatchableBinnedEntityIndexSet::NoEntities => {
        match indices.extra_index {
          ...
          PhaseItemExtraIndex::IndirectParametersIndex {
            ...
            *self = UnbatchableBinnedEntityIndexSet::Sparse {
              instance_range: indices.instance_index..indices.instance_index + 1,
              first_indirect_parameters_index: NonMaxU32::new(indirect_parameters_index.start),
            }
          }
        }
      }
      ...
      UnbatchableBinnedEntityIndexSet::Sparse {
        ...
        && ((first_indirect_parameters_index.is_none()
          ...
          || first_indirect_parameters_index.is_some_and(|first_indirect_parameters_index| {
            match indices.extra_index {
              PhaseItemExtraIndex::IndirectParametersIndex {
              ...
              PhaseItemExtraIndex::DynamicOffset(_) | PhaseItemExtraIndex::None => false,
            }
          })) =>
      {
  ...
  pub fn maybe_indirect_parameters_index(
    ...
    match indirect_parameters_index {
      Some(indirect_parameters_index) => PhaseItemExtraIndex::IndirectParametersIndex {
        range: u32::from(indirect_parameters_index)..(u32::from(indirect_parameters_index) + 1),
        batch_set_index: None,
      },
      None => PhaseItemExtraIndex::None,
    }
  ...
  fn render_multidrawable_batch_set() {
    ...
    impl ExpectedMultidrawableBatchSet {
      ...
      fn remove(&mut self, entity: MainEntity) -> GpuRenderBinnedMeshInstance {
        ...
        self.bin_index_to_entities[render_binned_mesh_instance.bin_index as usize].remove(&entity);
        self
          .input_uniform_index_to_entity
          ...
          for op in ops.iter() {
            match *op {
              RenderMultidrawableBatchSetOperation::Add {
                ...
                // structures.
                expected.insert(entity, RenderBinIndex(bin_index), input_uniform_index);
                batch_set.insert(
              ...
              RenderMultidrawableBatchSetOperation::Remove { entity_id } => {
                ...
                batch_set.remove(
                  entity,
                  &MockBinnedPhaseItemBinKey(render_binned_mesh_instance.bin_index),
                );
              }
            }
          }
    ...
    fn verify_entity_presence(
      ...
      entity_to_bin_index_and_input_uniform_index: &MainEntityHashMap<GpuRenderBinnedMeshInstance>,
    ) {
    ...
    fn verify_render_binned_mesh_instance_buffer(
      ...
      for (render_bin_buffer_index, gpu_render_binned_mesh_instance) in batch_set
        ...
        .enumerate()
      {
        let render_bin_buffer_index = RenderBinnedMeshInstanceIndex(render_bin_buffer_index as u32);

        let mapped_entity =
          batch_set.binned_mesh_instance_index_to_entity[render_bin_buffer_index.0 as usize];
