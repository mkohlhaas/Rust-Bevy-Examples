...
mod tests {
  ...
  fn test_round_trip_serialization() {
    ...
    let new_type_multi_tuple_struct = new_world.get_resource::<NewTypeMultiTupleStruct>().unwrap();
    ...
    let enum_multi_new_type_variant = new_world.get_resource::<EnumMultiNewTypeVariant>().unwrap();
    assert_eq!(
