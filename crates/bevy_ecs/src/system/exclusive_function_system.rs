  ...
  F: ExclusiveSystemParamFunction<Marker>,
{
  ...
  fn into_system(func: Self) -> Self::System {
    ExclusiveFunctionSystem {
      func,
      #[cfg(feature = "hotpatching")]
      current_ptr: subsecond::HotFn::current(<F as ExclusiveSystemParamFunction<Marker>>::run)
        .ptr_address(),
      param_state: None,
  ...
  F: ExclusiveSystemParamFunction<Marker>,
{
  ...
  fn refresh_hotpatch(&mut self) {
    let new =
      subsecond::HotFn::current(<F as ExclusiveSystemParamFunction<Marker>>::run).ptr_address();
