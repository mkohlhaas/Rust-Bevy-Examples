...
mod tests {
  ...
  fn spawn_and_delete() {
    ...
    let dynamic_world =
      DynamicWorld::from_world_with(&world, &app.world().resource::<AppTypeRegistry>().read());
      ...
      .run_system_once(
        |world: &World,
         ...
         asset_server: Res<'_, AssetServer>| {
          asset_server.add(
            WorldAsset::from_dynamic_world(&DynamicWorld::from_world(world), &type_registry.read())
              .unwrap(),
          )
        },
      )
