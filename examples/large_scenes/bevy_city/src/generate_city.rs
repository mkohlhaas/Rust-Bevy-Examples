  ...
  commands
    ...
    .with_children(|commands| {
      commands.spawn((
        ...
        Transform::from_translation(Vec3::new(2.75, 0.0, 0.0)).with_scale(Vec3::new(4.5, 1.0, 1.0)),
      ));
      stats.roads += 1;
  ...
  for x in 1..=5 {
    ...
    for tree_x in 0..=1 {
      ...
      commands.spawn((
        ...
        Transform::from_translation(Vec3::new(tree_x + x as f32 * x_factor, 0.0, 1.75) + offset),
      ));
      commands.spawn((
        WorldAssetRoot(assets.tree_large.clone()),
        Transform::from_translation(Vec3::new(tree_x + x as f32 * x_factor, 0.0, 2.25) + offset),
      ));
      stats.trees += 2;
    }
