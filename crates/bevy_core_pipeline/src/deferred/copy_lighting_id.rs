...
pub(crate) fn copy_deferred_lighting_id(
  ...
  let (_view_target, view_prepass_textures, deferred_lighting_id_depth_texture) = view.into_inner();
...
pub fn init_copy_deferred_lighting_id_pipeline(
  ...
  let layout = BindGroupLayoutDescriptor::new(
    ...
    &BindGroupLayoutEntries::single(ShaderStages::FRAGMENT, texture_2d(TextureSampleType::Uint)),
  );
