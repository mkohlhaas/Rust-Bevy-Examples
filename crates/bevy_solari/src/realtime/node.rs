...
use bevy_render::{
  ...
  render_resource::{
    ...
    ComputePassDescriptor, ComputePipelineDescriptor, LoadOp, PipelineCache, RenderPassDescriptor,
...
pub fn solari_lighting(
  ...
  let bind_group_resolve_dlss_rr_textures = view_dlss_rr_textures.map(|d| {
    render_device.create_bind_group(
      ...
      &pipeline_cache.get_bind_group_layout(&pipelines.bind_group_layout_resolve_dlss_rr_textures),
      &BindGroupEntries::sequential((
...
pub fn init_solari_lighting_pipelines(
  ...
  commands.insert_resource(SolariLightingPipelines {
    ...
    #[cfg(all(feature = "dlss", not(feature = "force_disable_dlss")))]
    bind_group_layout_resolve_dlss_rr_textures: bind_group_layout_resolve_dlss_rr_textures.clone(),
