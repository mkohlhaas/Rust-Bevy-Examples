...
mod tests {
  ...
  fn handle_from_reflect_verifies_type_id() {
    ...
    let handle_b_from_reflect: Option<Handle<B>> = FromReflect::from_reflect(reflected_handle_a);
    let handle_a_from_reflect: Option<Handle<A>> = FromReflect::from_reflect(reflected_handle_a);
    assert!(
  ...
  fn handle_from_reflect_and_try_apply() {
    ...
    let handle_1_from_reflect: Handle<A> = FromReflect::from_reflect(reflected_handle_1).unwrap();
