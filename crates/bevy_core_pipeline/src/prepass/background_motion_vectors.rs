...
impl Plugin for BackgroundMotionVectorsPlugin {
  fn build(&self, app: &mut App) {
    ...
    app
      .register_type::<NoBackgroundMotionVectors>()
    ...
    render_app
      ...
      .add_systems(
        ...
        (
          ...
          prepare_background_motion_vectors_bind_groups.in_set(RenderSystems::PrepareBindGroups),
        ),
      );
  }
}
...
fn init_background_motion_vectors_pipeline(
  ...
  commands.insert_resource(BackgroundMotionVectorsPipeline {
    ...
    fragment_shader: load_embedded_asset!(asset_server.as_ref(), "background_motion_vectors.wgsl"),
  });
}
