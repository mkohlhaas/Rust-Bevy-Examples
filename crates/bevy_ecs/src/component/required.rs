...
impl RequiredComponents {
  ...
  unsafe fn register_by_id<C: Component>(
    ...
    let constructor = || unsafe { RequiredComponentConstructor::new(component_id, constructor) };
...
impl Components {
  ...
  pub(crate) unsafe fn register_required_components<R: Component>(
    ...
    let required_required_components = unsafe {
      self
        .get_required_components(required)
    ...
    let required_components = unsafe {
      self
        .get_required_components_mut(requiree)
        .debug_checked_unwrap()
    };
    ...
    for &indirect_required in &new_required_components {
      ...
      let required_by = unsafe {
        self
          .get_required_by_mut(indirect_required)
          .debug_checked_unwrap()
      };
  ...
  unsafe fn required_components_scope<R>(
    ...
    let mut guard = DropGuard {
      ...
      required_components: core::mem::take(unsafe {
        self
          .get_required_components_mut(component_id)
          .debug_checked_unwrap()
      }),
      components: self,
    };
...
impl<'a, 'w> RequiredComponentsRegistrator<'a, 'w> {
  ...
  pub unsafe fn register_required_by_id<C: Component>(
    ...
    unsafe {
      self
        .required_components
        .register_by_id::<C>(component_id, self.components, constructor);
    }
  }
  ...
  pub unsafe fn register_required_dynamic_with(
    ...
    unsafe {
      self
        .required_components
        .register_dynamic_with(component_id, self.components, constructor);
    }
  }
}
