  ...
  c.benchmark_group(bench!("with_overload"))
    ...
    .bench_function(BenchmarkId::new("complex_overload", 1), |b| {
      b.iter_batched(
        ...
        |func| func.with_overload(complex::<i16, i32, i64, i128, u8, u16, u32, u64, u128, i8>),
        BatchSize::SmallInput,
      );
    })
    ...
    .bench_function(BenchmarkId::new("complex_overload", 3), |b| {
      b.iter_batched(
        ...
        |func| {
          func
            .with_overload(complex::<i16, i32, i64, i128, u8, u16, u32, u64, u128, i8>)
      ...
      b.iter_batched(
        ...
        |func| {
          func.with_overload(
            simple::<i16>
              .into_function()
              .with_overload(simple::<i32>.into_function().with_overload(simple::<i64>)),
          )
        },
        BatchSize::SmallInput,
      );
                    ...
                    simple::<u8>.into_function().with_overload(
                      simple::<u16>.into_function().with_overload(
                        simple::<u32>.into_function().with_overload(
                          simple::<u64>.into_function().with_overload(simple::<u128>),
                        ),
                      ),
                    ),
                  ),
