...
pub fn prepare_solari_lighting_resources(
  ...
  for query_item in &query {
    ...
    let light_tile_resolved_samples = render_device.create_buffer(&BufferDescriptor {
      ...
      size: LIGHT_TILE_BLOCKS * LIGHT_TILE_SAMPLES_PER_BLOCK * RESOLVED_LIGHT_SAMPLE_STRUCT_SIZE,
      usage: BufferUsages::STORAGE,
      mapped_at_creation: false,
    });
    ...
    let world_cache_active_cells_new_radiance = render_device.create_buffer(&BufferDescriptor {
