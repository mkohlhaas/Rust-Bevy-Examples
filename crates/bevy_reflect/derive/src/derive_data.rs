...
use syn::{
  ...
  GenericParam, Generics, Ident, LitStr, Member, Meta, Path, PathSegment, Type, TypeParam, Variant,
};
  ...
  pub fn from_input(
    ...
    match &input.data {
      Data::Struct(data) => {
        ...
        let serialization_data = SerializationDataDef::new(&fields, &meta.bevy_reflect_path)?;
