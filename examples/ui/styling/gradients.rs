  ...
  commands
    ...
    .with_children(|commands| {
      ...
      let button = commands
        ...
        .observe(
          |_event: On<Pointer<Click>>,
           ...
           mut label_query: Query<&mut Text, With<CurrentColorSpaceLabel>>| {
            ...
            for mut gradients in gradients_query.iter_mut() {
              for gradient in gradients.0.iter_mut() {
                ...
                *space = match *space {
                  ...
                  InterpolationColorSpace::OklchaLong => InterpolationColorSpace::Srgba,
                  InterpolationColorSpace::Srgba => InterpolationColorSpace::LinearRgba,
                  InterpolationColorSpace::LinearRgba => InterpolationColorSpace::Hsla,
                  InterpolationColorSpace::Hsla => InterpolationColorSpace::HslaLong,
                  InterpolationColorSpace::HslaLong => InterpolationColorSpace::Hsva,
                  InterpolationColorSpace::Hsva => InterpolationColorSpace::HsvaLong,
                  InterpolationColorSpace::HsvaLong => InterpolationColorSpace::Oklaba,
                };
                current_space = *space;
              }
            }
      ...
      commands
        ...
        .with_children(|commands| {
          commands.spawn((
            Text::new(format!("{:?}", InterpolationColorSpace::default())),
            TextFont {
