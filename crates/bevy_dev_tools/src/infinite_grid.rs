...
use bevy_render::{
  ...
  render_resource::{
    ...
    PrimitiveState, RenderPipelineDescriptor, ShaderStages, ShaderType, SpecializedRenderPipeline,
...
impl<P: PhaseItem> RenderCommand<P> for DrawInfiniteGridCommand {
  ...
  fn render<'w>(
    _item: &P,
    (view_uniform, view_bind_group, camera_settings_offset): ROQueryItem<'w, '_, Self::ViewQuery>,
