...
fn spawn_scene(
  ...
  let sphere_material = StandardMaterial {
    base_color_texture: Some(asset_server.load("textures/GroundSand005/GroundSand005_COL_2K.jpg")),
    perceptual_roughness: 1.0,
    metallic_roughness_texture: Some(orm.clone()),
    normal_map_texture: Some(asset_server.load("textures/GroundSand005/GroundSand005_NRM_2K.jpg")),
