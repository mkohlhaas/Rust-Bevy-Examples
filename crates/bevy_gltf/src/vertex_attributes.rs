...
pub fn convert_attribute(
  ...
  if let Some((attribute, conversion, convert_coordinates)) = match &semantic {
    ...
    gltf::Semantic::TexCoords(0) => Some((Mesh::ATTRIBUTE_UV_0, ConversionMode::TexCoord, false)),
    gltf::Semantic::TexCoords(1) => Some((Mesh::ATTRIBUTE_UV_1, ConversionMode::TexCoord, false)),
