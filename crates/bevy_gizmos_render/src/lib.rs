...
use {
  ...
  bevy_render::{
    ...
    render_resource::{
      binding_types::uniform_buffer, BindGroup, BindGroupEntries, BindGroupLayoutEntries, Buffer,
      BufferInitDescriptor, BufferUsages, ShaderStages, ShaderType, VertexFormat,
    },
