...
impl RenderAsset for GpuImage {
  ...
  fn prepare_asset(
    ...
    let sampler = match image.sampler {
      ...
      ImageSampler::Descriptor(descriptor) => render_device.create_sampler(&descriptor.as_wgpu()),
    };
...
impl GpuImage {
  ...
  pub fn aspect_ratio(&self) -> AspectRatio {
    ...
    .expect("Failed to calculate aspect ratio: Image dimensions must be positive, non-zero values")
  }
