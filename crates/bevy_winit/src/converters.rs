...
pub fn convert_logical_key(logical_key_code: &Key) -> bevy_input::keyboard::Key {
  match logical_key_code {
    ...
    Key::Named(NamedKey::AudioBassBoostToggle) => bevy_input::keyboard::Key::AudioBassBoostToggle,
    ...
    Key::Named(NamedKey::AudioSurroundModeNext) => bevy_input::keyboard::Key::AudioSurroundModeNext,
    ...
    Key::Named(NamedKey::MicrophoneVolumeDown) => bevy_input::keyboard::Key::MicrophoneVolumeDown,
    Key::Named(NamedKey::MicrophoneVolumeUp) => bevy_input::keyboard::Key::MicrophoneVolumeUp,
    Key::Named(NamedKey::MicrophoneVolumeMute) => bevy_input::keyboard::Key::MicrophoneVolumeMute,
    Key::Named(NamedKey::SpeechCorrectionList) => bevy_input::keyboard::Key::SpeechCorrectionList,
    ...
    Key::Named(NamedKey::TVTerrestrialDigital) => bevy_input::keyboard::Key::TVTerrestrialDigital,
