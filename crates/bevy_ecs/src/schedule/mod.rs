...
mod tests {
  ...
  mod conditions {
    ...
    fn mixed_conditions_and_change_detection() {
      ...
      schedule
        .configure_sets(TestSystems::A.run_if(|res1: Res<RunConditionBool>| res1.is_changed()));
  ...
  mod stepping {
    ...
    fn assert_executor_supports_stepping(executor: impl SystemExecutor + 'static) {
      ...
      let mut system_state: SystemState<Option<ResMut<Stepping>>> = SystemState::new(&mut world);
