...
mod tests {
  ...
  fn setup_react_to_scale_factor_change_test_app(
    ...
    app.add_systems(
      ...
      move |mut window: Single<(Entity, &mut Window)>,
        ...
        WindowBackendScaleFactorChanged,
      >,
            mut window_scale_factor_changed_writer: MessageWriter<WindowScaleFactorChanged>,
  ...
  fn test_react_to_resize_with_changed_size() {
    ...
    let mut window_resized_messages_iter = window_resized_messages.iter_current_update_messages();
    assert_eq!(
